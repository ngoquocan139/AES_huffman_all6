//===================================================================
// File: aes128_cipher_core_inv.v
// Description: AES-128 decrypt/decipher core (Verilog-2001)
// Notes: Converted from SystemVerilog to Verilog-2001 without changing logic.
// Author (original): Nguyen Hung Quan
// Website: http://nguyenquanicd.blogspoaes128_cipher_core_inv.vt.com/
// Dependencies:
//   - aes_inverse_funcs.v  (provides aes128_sbox() and mixcolInv())
//===================================================================
...
`include "aes_inverse_funcs.vh"
    ...
    // ----------------------------------------------------------------
    reg  [3:0]   decipher_counter;
    wire         decipher_complete;

    wire [127:0] InvShiftRows_in;
    ...
    wire [127:0] InvShiftRows_result;
    ...
    // ----------------------------------------------------------------
    // InvMixColumns - only input from AddRoundKey (plainText_reg)
    // ----------------------------------------------------------------
    ...
    assign after_AddRoundKey     = AddRoundKey_in[127:0] ^ round_key[127:0];
