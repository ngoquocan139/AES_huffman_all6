...
| `dma_compress_aes_alnum63_cov` | 504 bytes | `COMPRESS_AES` | 100.67% | -0.67% | 107.94% | -7.94% |
...
| `dma_compress_aes_alnum63_cov` | Full TX/RX max-valid-symbol loopback at 63 symbols |
